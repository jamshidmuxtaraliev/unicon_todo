...
class TaskBloc extends Bloc<TaskEvent, TaskState> {
  ...
  Future<void> _reload(Emitter<TaskState> emit) async {
    ...
    either.fold(
      (err) => emit(state.copyWith(status: FormzSubmissionStatus.failure, errorMessage: err.message)),
      (list) => emit(state.copyWith(status: FormzSubmissionStatus.success, items: list, errorMessage: null)),
    );
  }
  ...
  Future<void> _onAddTask(AddTaskEvent event, Emitter<TaskState> emit) async {
    ...
    await either.fold(
      (err) async => emit(state.copyWith(status: FormzSubmissionStatus.failure, errorMessage: err.message)),
